...
//
extern __declspec(dllexport) Result_Dict_QuoteData query_quotes_latest(Optional_String id, Optional_String slug, Optional_String convert, Optional_String convert_id, Optional_String aux, Optional_Bool skip_invalid);
extern __declspec(dllexport) void query_quotes_latest_release(Result_Dict_QuoteData result);
extern __declspec(dllexport) Result_List_Cryptocurrency query_id_map(Optional_String listing_status, Optional_String sort, Optional_String symbol, Optional_String aux, Optional_Int start, Optional_Int limit);
extern __declspec(dllexport) void query_id_map_release(Result_List_Cryptocurrency result);

// TODO: symbol请求与id和slug格式不符，暂未实现
//
extern __declspec(dllexport) Result_Dict_Metadata query_metadata(Optional_String id, Optional_String slug, Optional_String address, Optional_String aux, Optional_Bool skip_invalid);
